...
public class JDialog_AddCCAccount extends JDialog
{
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
		...
		if (!parentframe.ccnumber.isEmpty() &&
				...
				!parentframe.email.isEmpty()) {
			Address address = new Address(parentframe.street, parentframe.city, parentframe.zip, parentframe.state);
			CardDTO cardDTO = new CardDTO(parentframe.clientName, address, 0,parentframe.accountType, parentframe.expdate, parentframe.ccnumber,parentframe.email);
			Account account = parentframe.getBankService().createCreditAccount(cardDTO);
