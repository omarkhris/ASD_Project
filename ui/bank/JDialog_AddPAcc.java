...
public class JDialog_AddPAcc extends JDialog
{
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
		...
		if (!parentframe.accountnr.isEmpty() &&
			...
			BankDTO bankDTO = new BankDTO(parentframe.accountnr, parentframe.clientName, address, parentframe.accountType, parentframe.email, "Personal", parentframe.currentBalance, parentframe.birthDate, null);
