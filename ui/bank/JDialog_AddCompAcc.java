...
public class JDialog_AddCompAcc extends JDialog {
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) {
		...
		parentframe.numberOfMember = JTextField_NoOfEmp.getText();
		...
		if (!parentframe.accountnr.isEmpty() &&
				!parentframe.clientName.isEmpty() &&
				!parentframe.street.isEmpty() &&
				!parentframe.city.isEmpty() &&
				!parentframe.zip.isEmpty() &&
				!parentframe.state.isEmpty()) {
			Address address = new Address(parentframe.street, parentframe.city, parentframe.zip, parentframe.state);
			BankDTO bankDTO = new BankDTO(parentframe.accountnr, parentframe.clientName, address, parentframe.accountType, parentframe.email, "Company", parentframe.currentBalance, null, parentframe.numberOfMember);
			Account account = parentframe.getBankService().createBankingAccount(bankDTO);
			Customer customer = account.getCustomer();
			customer.addAccount(account);
			parentframe.addCustomer(customer);
			dispose();
		} else {
			JButton JButton_Withdraw = new JButton();
			JOptionPane.showMessageDialog(JButton_Withdraw, " fill required field", "Warning: Miss Required Filled", JOptionPane.WARNING_MESSAGE);

			System.out.println("fill required field");
		}
