...
public class Main {
    public static void main(String[] args) {
        ...
        RetailCustomer retailCustomer = new RetailCustomer("jack", retailAddress, "Doe@gmail.com");
        ...
        System.out.println("Balance: "+balance);
        RetailCustomer loadedRetailCustomer =(RetailCustomer) persistenceFacade.loadCustomer("Doe@gmail.com");
